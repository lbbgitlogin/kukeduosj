...
Page({
  ...
  InitData: function () {
    ...
    $.xsr($.makeUrl(fgapi.GetOngoingLuckyEventList, obj), function (res) {//未拼团
    console.log(res)
  ...
  initialData: function () {
    ...
    $.xsr($.makeUrl(fgapi.GetUpcomingLuckyEventList, obj), function (res) {//未拼团
    console.log(res)
      if (!$.isNull(res.Info) && res.Code == 0) {
        that.setData({
          isData1: true
  ...
  onShareAppMessage: function (res) {
    return {
      title: '限量抽豪礼，邀请好友开心抽奖',
      path: 'pages/luckyfightgroupslist/luckyfightgroupslist?uid=' + app.globalData.UserInfo.Id
    }
  }
})